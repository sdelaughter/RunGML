function RunGML_DefineConstants() {
	...
	// https://github.com/tabularelf/GMLspeak/blob/main/scripts/GMLspeakEnvironment/GMLspeakEnvironment.gml
	...
	struct_foreach({
		...
		//"fps":				function() {return fps;}, // Operator defined
	...
	new RunGML_Enum("AudioEffectType", {
	...
	new RunGML_Enum("flexpanel_align", {
